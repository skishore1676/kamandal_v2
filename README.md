...
- `scripts/run_iv_capture.sh`: trading days at 14:50 Central. Captures one local IV observation per enabled universe symbol from Public option chains while option quotes are still live near the close.
