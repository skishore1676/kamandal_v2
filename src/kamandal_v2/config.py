...
def load_control(config_path: str | Path | None = None) -> dict[str, Any]:
    ...
    overrides = {
        ...
        "live.operator_review.lathi_profile": os.environ.get("KAMANDAL_OPERATOR_REVIEW_LATHI_PROFILE"),
        "live.operator_review.lathi_mode": os.environ.get("KAMANDAL_OPERATOR_REVIEW_LATHI_MODE"),
