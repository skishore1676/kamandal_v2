...
def load_control(config_path: str | Path | None = None) -> dict[str, Any]:
    ...
    overrides = {
        ...
        "live.plan_fallback.enabled": _env_bool("KAMANDAL_LIVE_PLAN_FALLBACK_ENABLED"),
        "live.plan_fallback.max_attempts": _env_int("KAMANDAL_LIVE_PLAN_FALLBACK_MAX_ATTEMPTS"),
        "live.plan_fallback.auto_submit": _env_bool("KAMANDAL_LIVE_PLAN_FALLBACK_AUTO_SUBMIT"),
        ...
        "live.entry_pricing.campaign.enabled": _env_bool("KAMANDAL_ENTRY_CAMPAIGN_ENABLED"),
        "live.entry_pricing.campaign.initial_improvement_multiplier": _env_float("KAMANDAL_ENTRY_CAMPAIGN_START_MULTIPLIER"),
        "live.entry_pricing.campaign.allowance_pct_of_midpoint": _env_float("KAMANDAL_ENTRY_CAMPAIGN_ALLOWANCE_PCT"),
        "live.entry_pricing.campaign.allowance_max_fraction_of_improvement": _env_float("KAMANDAL_ENTRY_CAMPAIGN_ALLOWANCE_IMPROVEMENT_FRACTION"),
        "live.entry_pricing.campaign.absolute_allowance_cap": _env_float("KAMANDAL_ENTRY_CAMPAIGN_ABSOLUTE_CAP"),
        "live.entry_pricing.campaign.valid_tick": _env_float("KAMANDAL_ENTRY_CAMPAIGN_VALID_TICK"),
        "live.entry_pricing.campaign.absurd_bid_ask_pct": _env_float("KAMANDAL_ENTRY_CAMPAIGN_ABSURD_BID_ASK_PCT"),
        ...
        "broker.tastytrade.orders_api_version": os.environ.get("TASTYTRADE_ORDERS_API_VERSION"),
